...
const CatFormModel:React.FC<FormProps&EditedCatsAttributes> = ({id,breed,multiplier,price,name,picture, errors, setname, setbreed, setmultiplier, setprice, breedOptions, handleImageChange, handleDelete})=>{
